(() => {
	...
	function Table(props, content) {
		props = _validateProps(props, content);
		return HTMLElementCreator('table', props);
	}

	function Tr(props, content) {
		props = _validateProps(props, content);
		return HTMLElementCreator('tr', props);
	}

	function Td(props, content) {
		props = _validateProps(props, content);
		return HTMLElementCreator('td', props);
	}

	function Th(props, content) {
		props = _validateProps(props, content);
		return HTMLElementCreator('th', props);
	}
	/**
